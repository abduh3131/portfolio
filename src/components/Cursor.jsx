...
const Cursor = () => {
  ...
  useEffect(() => {
    ...
    let rx = mx, ry = my, dx = mx, dy = my, raf
    ...
    const onOver = (e) => {
      ...
      if (t.closest('a, button, [role="button"], .mbtn, .bento__cell, .pcard, .project__link, .nav__link, .contact__channel, .cta__email, .resume__download')) {
        setVariant('hover')
